export const ASPECT_RATIO_PRESETS = [
  ...
  },
  {
    group: "Фото и печат",
    items: [
      { id: "4-3", ratio: "4:3", label: "Стандарт", width: 1600, height: 1200 },
      ...
      { id: "5-4", ratio: "5:4", label: "Монитор", width: 1280, height: 1024 },
      { id: "5-3", ratio: "5:3", label: "5:3", width: 1600, height: 960 },
      { id: "2-3-portrait", ratio: "2:3", label: "Портрет", width: 1200, height: 1800 },
    ],
  },
  {
    group: "Социални мрежи",
    items: [
      { id: "1-1-square", ratio: "1:1", label: "Квадрат", width: 1080, height: 1080 },
      ...
      { id: "2-1-banner", ratio: "2:1", label: "Банер", width: 2000, height: 1000 },
